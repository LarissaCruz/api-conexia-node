...
const upload = multer({
  dest: "uploads/",
  limits: { fileSize: 200 * 1024 * 1024 }, // Limite de 10MB
});
...
router.get("/usuarios/sugestion/", UsuarioController.getAllUsuario);
...
router.get(
  "/publicacoes/:id",
  PublicacaoController.listarPublicacoesPorUsuario
);
